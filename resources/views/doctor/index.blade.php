  ...
  <aside id="sidebar-wrapper">
    ...
    <div class="sidebar-brand">
      <a href="{{ url('/doctor/dashboard') }}">
        ...
        <span class="logo-name">Doctor Panel</span>
      </a>
    </div>

    <!-- 🔹 Sidebar Menu -->
    <ul class="sidebar-menu">
      <li class="menu-header">Doctor Panel</li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item" href="{{ route('admin.showdoc') }}">Show All Doctors</a></li>
